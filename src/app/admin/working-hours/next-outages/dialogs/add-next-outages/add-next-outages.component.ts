...
import { OT_NextOutages, OT_SiteNextOutage, OT_IEquipments } from 'src/app/admin/outage-tracker/next-outages/site-next-outages.model';
...
export class AddNextOutagesComponent extends UnsubscribeOnDestroyAdapter {
  ...
  buildform(): FormGroup {
    return this.fb.group({
      ...
      runningHours:[this.siteNextOutages.runningHours, [Validators.required]],
  ...
  submit() {
    ...
    this.siteNextOutages.runningHours = +this.outageForm.value.runningHours;
