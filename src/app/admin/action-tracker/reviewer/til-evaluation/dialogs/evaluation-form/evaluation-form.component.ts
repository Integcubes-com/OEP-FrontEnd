...
import { TilEvaluationForm, TILs } from 'src/app/admin/action-tracker/tils/add-tils/add-tils.model';
...
export class EvaluationFormComponent {
  ...
  constructor
    ...
    if (data.til.technicalReviewId) {
      ...
      this.tilEvaluation.teSummary =this.data.til.technicalReviewSummary;
debugger;
    }
    else {
